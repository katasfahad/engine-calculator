...
function start(){
    sel.addEventListener('change', choseItem, false);
}
function choseItem(){
    if(sel.value == 'ci'){
        b.innerHTML = 'Piston/Bore (Cubic Inches)';
        s.innerHTML ='CrankShaft/Stroke size (Cubic Inches)';
    }else if(sel.value == 'cc'){
        b.innerHTML = 'Piston/Bore (Milimeters)';
        s.innerHTML ='CrankShaft/Stroke size (Milimeters)'; 
    }
}
